...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-css-bug.com'
  config.app_name = 'Volt-css-bug'
  config.mailer.from = 'Volt-css-bug <no-reply@volt-css-bug.com>'
  ...
  #
  config.app_secret = 'PWhNTEOgWIcce5j6-eQwc2T-_A134LXyLbzcd7K6JjTV65X82tYPZ9KUjRDCcH7M0ck'
